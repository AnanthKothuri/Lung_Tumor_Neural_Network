...
from dsets import LunaDataset, TrainingLunaDataset, getCt
...
class SegmentationTrainingApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument('--load-epoch',
                            help="Load weights from a specific epoch",
                            default=0,
                            type=int,
                            )
    ...
    # Basically F1 score per pixel for segmentation
    ...
    def main(self):
        ...
        self.segmentation_model = torch.load("models/{}".format(model_file))

        self.validation_cadence = 3
        end_point = start_point + self.cli_args.epochs

        for epoch_ndx in range(start_point + 1, end_point + 1):
    ...
    def logImages(self, epoch_ndx, mode_str, dl):
        ...
        for series_ndx, series_uid in enumerate(images):
            ...
            for slice_ndx in range(6):
                ct_ndx = slice_ndx * (ct.hu_a.shape[0] - 1)
    ...
    def saveModel(self, type_str, epoch_ndx, isBest=False):
        ...
        file_path = os.path.join(
            "models/epoch{}.obj".format(epoch_ndx)
        )
