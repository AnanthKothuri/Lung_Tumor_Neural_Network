...
def getCandidateInfoList(requireOnDisk_bool=True):
    ...
    # the subsets yet.
    mhd_list = glob.glob('/Users/maadhavkothuri/Desktop/Tumor Data/subset*/*.mhd')

    # TAKING ONLY A SMALL SECTION

    presentOnDisk_set = {os.path.split(p)[-1][:-4] for p in mhd_list}

    candidateInfo_list = []

    ####Change this file to cleaned annotations provided by book
    with open('/Users/maadhavkothuri/Desktop/Tumor Data/annotations_with_malignancy.csv', "r") as f:
    ...
    with open('/Users/maadhavkothuri/Desktop/Tumor Data/candidates.csv', "r") as f:
        for row in list(csv.reader(f))[1:]:
            series_uid = row[0]
...
class Ct:
    def __init__(self, series_uid):
        mhd_path = glob.glob(
            '/Users/maadhavkothuri/Desktop/Tumor Data/subset*/{}.mhd'.format(series_uid)
        )[0]
...
class TrainingLunaDataset(LunaDataset):
